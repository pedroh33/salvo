	...
	public CommandLineRunner initData(
		...
		return (args) -> {
			...
			*/
			...
			// Juego 1
			Ship S1 = new Ship("Destroyer", Arrays.asList("H2", "H3", "H4"), GP1);
			Ship S2 = new Ship("Submarine", Arrays.asList("E1", "F1", "G1"),GP1);
			Ship S3 = new Ship("Patrol Boat", Arrays.asList("B4", "B5"),GP1);
			Ship S4 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP2);
			Ship S5 = new Ship("Patrol Boat",Arrays.asList("F1", "F2"),GP2);
			// Juego 2
			Ship S6 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP3);
			Ship S7 = new Ship("Patrol Boat",Arrays.asList("C6", "C7"),GP3);
			Ship S8 = new Ship("Submarine",Arrays.asList("A2", "A3", "A4"),GP4);
			Ship S9 = new Ship("Patrol Boat",Arrays.asList("G6", "H6"),GP4);
			// Juego 3
			Ship S10 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP5);
			Ship S11 = new Ship("Patrol Boat",Arrays.asList("C6", "C7"),GP5);
			Ship S12 = new Ship("Submarine",Arrays.asList("A2", "A3", "A4"),GP6);
			Ship S13 = new Ship("Patrol Boat",Arrays.asList("G6", "H6"),GP6);
			// Juego 4
			Ship S14 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP7);
			Ship S15 = new Ship("Patrol Boat",Arrays.asList("C6", "C7"),GP7);
			Ship S16 = new Ship("Submarine",Arrays.asList("A2", "A3", "A4"),GP8);
			Ship S17 = new Ship("Patrol Boat",Arrays.asList("G6", "H6"),GP8);
			// Juego 5
			Ship S18 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP9);
			Ship S19 = new Ship("Patrol Boat", Arrays.asList("C6", "C7"),GP9);
			Ship S20 = new Ship("Submarine", Arrays.asList("A2", "A3", "A4"),GP10);
			Ship S21 = new Ship("Patrol Boat",Arrays.asList("G6", "H6"),GP10);
			// Juego 6
			Ship S22 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP11);
			Ship S23 = new Ship("Patrol Boat", Arrays.asList("C6", "C7"),GP11);
			// Juego 8
			Ship S24 = new Ship("Destroyer",Arrays.asList("B5", "C5", "D5"),GP15);
			Ship S25 = new Ship("Patrol Boat",Arrays.asList("C6", "C7"),GP15);
			Ship S26 = new Ship("Submarine", Arrays.asList("A2", "A3", "A4"),GP16);
			Ship S27 = new Ship("Patrol Boat",Arrays.asList("G6", "H6"),GP16);
